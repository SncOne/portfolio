...
const socials = [
  {
    label: 'GitHub',
    href: 'https://github.com/turkergurel',
  },
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/turkergurel',
  },
  {
    label: 'Email',
    href: 'mailto:hello@turkergurel.com',
  },
]
    ...
    <section className="space-y-12">
      <FadeIn className="space-y-6">
        ...
        <h1 className="text-4xl font-semibold tracking-tight text-balance sm:text-5xl">
          Hi, I&apos;m Türker Gürel. I design and build product experiences that feel effortless and ship fast.
        </h1>
        <p className="text-lg text-muted-foreground">
          I specialise in crafting polished mobile and web applications, leading end-to-end delivery from concept to
          production. I partner with founders and teams to ship reliable, scalable interfaces with buttery-smooth
          interactions.
        </p>
      ...
      <FadeIn delay={0.1} className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
        {socials.map(({ label, href }) => (
          <Link key={label} href={href} className="group inline-flex items-center gap-2">
